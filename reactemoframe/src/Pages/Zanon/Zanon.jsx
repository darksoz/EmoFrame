                            ...
                            <div>
                                <form>
                                    ...
                                    <ul class="likert-zanon">
                                        ...
                                        <li>
                                            <input class="form-check-input" type="radio" name="likert-zanon1" value="99" />
                                    ...
                                    <ul class="likert-zanon">
                                     ...
                                     <li>
                                            <input class="form-check-input" type="radio" name="likert-zanon2" value="99" />
                                            <p>Não quero responder</p>  
                                        </li>
                                    ...
                                    <ul class="likert-zanon">
                                     ...
                                     <li>
                                            <input class="form-check-input" type="radio" name="likert-zanon3" value="99" />
                                            <p>Não quero responder</p>  
                                        </li>
                                    ...
                                    <ul class="likert-zanon">
                                     ...
                                     <li>
                                            <input class="form-check-input" type="radio" name="likert-zanon4" value="99" />
                                            <p>Não quero responder</p>  
                                        </li>
                                    ...
                                    <ul class="likert-zanon">
                                     ...
                                     <li>
                                            <input class="form-check-input" type="radio" name="likert-zanon5" value="99" />
                                            <p>Não quero responder</p>  
                                        </li>
                                    ...
                                    <ul class="likert-zanon">
                                     ...
                                     <li>
                                            <input class="form-check-input" type="radio" name="likert-zanon6" value="99" />
                                            <p>Não quero responder</p>  
                                        </li>
                                    ...
                                    <ul class="likert-zanon">
                                     ...
                                     <li>
                                            <input class="form-check-input" type="radio" name="likert-zanon7" value="99" />
                                            <p>Não quero responder</p>  
                                        </li>
                                    ...
                                    <ul class="likert-zanon">
                                     ...
                                     <li>
                                            <input class="form-check-input" type="radio" name="likert-zanon8" value="99" />
                                            <p>Não quero responder</p>  
                                        </li>
                                    ...
                                    <ul class="likert-zanon">
                                     ...
                                     <li>
                                            <input class="form-check-input" type="radio" name="likert-zanon9" value="99" />
                                            <p>Não quero responder</p>  
                                        </li>
                                    ...
                                    <ul class="likert-zanon">
                                     ...
                                     <li>
                                            <input class="form-check-input" type="radio" name="likert-zanon10" value="99" />
                                            <p>Não quero responder</p>  
                                        </li>
                                    ...
                                    <ul class="likert-zanon">
                                     ...
                                     <li>
                                            <input class="form-check-input" type="radio" name="likert-zanon11" value="99" />
                                            <p>Não quero responder</p>  
                                        </li>
...
raiva de algumas pessoas.</label>
                                    <ul class="likert-zanon">
                                     ...
                                     <li>
                                            <input class="form-check-input" type="radio" name="likert-zanon12" value="99" />
                                            <p>Não quero responder</p>  
                                        </li>
...
da vida.</label>
                                    <ul class="likert-zanon">
                                     ...
                                     <li>
                                            <input class="form-check-input" type="radio" name="likert-zanon13" value="99" />
                                            <p>Não quero responder</p>  
                                        </li>
                                    ...
                                    <ul class="likert-zanon">
                                     ...
                                     <li>
                                            <input class="form-check-input" type="radio" name="likert-zanon14" value="99" />
                                            <p>Não quero responder</p>  
                                        </li>
                                    ...
                                    <ul class="likert-zanon">
                                     ...
                                     <li>
                                            <input class="form-check-input" type="radio" name="likert-zanon15" value="99" />
                                            <p>Não quero responder</p>  
                                        </li>
                                    ...
                                    <ul class="likert-zanon">
                                     ...
                                     <li>
                                            <input class="form-check-input" type="radio" name="likert-zanon16" value="99" />
                                            <p>Não quero responder</p>  
                                        </li>
                                    ...
                                    <ul class="likert-zanon">
                                     ...
                                     <li>
                                            <input class="form-check-input" type="radio" name="likert-zanon17" value="99" />
                                            <p>Não quero responder</p>  
                                        </li>
...
senti humilhado(a).</label>
                                    <ul class="likert-zanon">
                                     ...
                                     <li>
                                            <input class="form-check-input" type="radio" name="likert-zanon18" value="99" />
                                            <p>Não quero responder</p>  
                                        </li>
                                    ...
                                    <ul class="likert-zanon">
                                     ...
                                     <li>
                                            <input class="form-check-input" type="radio" name="likert-zanon19" value="99" />
                                            <p>Não quero responder</p>  
                                        </li>

                                    </ul>

                                    <label class="statement-leap text-start">Sou uma pessoa feliz.</label>
                                    <ul class="likert-zanon">
                                        <li>
                                            <input class="form-check-input" type="radio" name="likert-zanon20" value="1" />
                                             <p> Não tem nada a ver comigo</p> 
                                        </li>
                                        <li>
                                            <input class="form-check-input" type="radio" name="likert-zanon20" value="2" />
                                             <p> Tem pouco a ver comigo</p> 
                                        </li>
                                        <li>
                                            <input class="form-check-input" type="radio" name="likert-zanon20" value="3" />
                                            <p> Ás vezes tem e às vezes não tem a ver comigo</p>
                                        </li>
                                        <li>
                                            <input class="form-check-input" type="radio" name="likert-zanon20" value="4" />
                                             <p> Tem muito a ver comigo</p>
                                        </li>
                                        <li>
                                            <input class="form-check-input" type="radio" name="likert-zanon20" value="5" />
                                            <p> Tem tudo a ver comigo</p> 
                                        </li>

                                     <li>
                                            <input class="form-check-input" type="radio" name="likert-zanon20" value="99" />
                                            <p>Não quero responder</p>  
                                        </li>
